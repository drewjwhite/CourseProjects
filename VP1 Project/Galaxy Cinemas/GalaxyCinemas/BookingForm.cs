...
namespace GalaxyCinemas
{
    public partial class BookingForm : Form
    {
        ...
        private void UpdatePrice()
        {
            ...
            try
            {
                int.TryParse(txtQuantity.Text, out quant);
            }
            catch
            {
                MessageBox.Show(this, "The quantity is not a valid number. Please re-enter.", "Price Calculation Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            originalPrice = quant * BASETICKETPRICE;

            // Prepare to compare original price to special prices.
            decimal finalPrice = originalPrice;
            booking.OriginalPrice = originalPrice;
            string specialName = "";
            lblSpecialName.Text = "No special applied...";
            lblOriginalPrice.Text = originalPrice.ToString("C");
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            if (IsFormValid())
            {
                ...
                MessageBox.Show("Added booking #" + booking.BookingNumber, "Booking submitted", MessageBoxButtons.OK, MessageBoxIcon.Information);
                this.Close();
            }
            else
            {
